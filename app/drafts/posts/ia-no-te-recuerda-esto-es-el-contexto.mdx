...
- el *system prompt* con las instrucciones base, como el tono, como comportarse, o qué tipo de respuestas dar.
...
El contexto es una parte fundamental de cómo funciona la IA. Como mejor contexto le des, mejor podrá responder, pero ojo, mejor no es más contexto, sino el contexto correcto.
